    ...
    public int process(List<Update> updates) {
        updates.forEach(update -> {
            ...
            if (textMessage.equals("/start")) {
                telegramBot.execute(new SendMessage(chatId, "Здравствуйте, " + firstName + " " + lastName + ". " +
                        "Я бот-напоминалка. Отправьте мне сообщение в формате ДД.ММ.ГГГГ ЧЧ:ММ и дело, которое нужно сделать, чтобы я мог тебе о нём напомнить.")
